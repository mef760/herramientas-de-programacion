...
namespace Clase5.Controllers
{
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Make,Model,Year,Plate,Color")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Make,Model,Year,Plate")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
